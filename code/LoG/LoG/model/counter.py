...
class Counter(nn.Module):
    ...
    def update_by_output(self, output, fix_parent=False):
        for i in range(len(output['render'])):
            ...
            try:
                self.area_sum[visible_index[point_id.long()]] += point_count
            except:
                print(i)
                print(visible_index)
                print(point_id)
            ...
            # weight by the area
            self.grad_sum[visible_index[point_id.long()]] += grad_norm[point_id.long()] * point_count
            ...
            self.radii_max_max[visible_index[point_id.long()]] = torch.maximum(point_count.int(), self.radii_max_max[visible_index[point_id.long()]])