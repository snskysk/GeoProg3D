...
class Camera(nn.Module):
    ...
    def get_language_feature(self, language_feature_dir, feature_level):
        ...
        seg_map = torch.from_numpy(np.load(language_feature_name + '_s.npy'))# torch.Size([4, 730, 988]) case frame_00157_s.npy
        ...
        y, x = torch.meshgrid(torch.arange(0, self.image_height), torch.arange(0, self.image_width))# y = torch.Size([730, 988]), x = torch.Size([730, 988])
