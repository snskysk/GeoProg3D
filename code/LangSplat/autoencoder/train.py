...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', type=str, required=True, help="Parent directory where language_features is located")
    ...
    parser.add_argument('--dataset_name', type=str, required=True, help="Directory name of the checkpoint to be saved")
    ...
    for epoch in tqdm(range(num_epochs)):
        ...
        # if epoch > 95:
        if epoch > num_epochs - 5 or epoch % 5 == 0:
            eval_loss = 0.0
            model.eval()
            ...
            if epoch > num_epochs - 5:# Save the best of the last 5 epochs
    ...
    print("--- completed ---")
    print('ckpts/{}/best_ckpt.pth'.format(args.dataset_name))